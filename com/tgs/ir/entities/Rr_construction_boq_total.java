...
public class Rr_construction_boq_total {
...
@Column(name="rr_admin_id")
 ...
 private Integer  rrAdminId;
    ...
    public Rr_construction_boq_total(int rr_boq_total_id, int project_id, int package_id, Object name_of_work, int district_id, int mandal_id, int village_id, double total_amount, boolean delete_flag, Object submited_by, Object submited_time, boolean edit_flag, Object edit_time, boolean is_latest, Object edit_by, int rr_admin_id) {
