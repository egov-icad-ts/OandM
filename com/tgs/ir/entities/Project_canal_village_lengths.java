...
public class Project_canal_village_lengths {
@Column(name="lsv_id")
...
@Column(name="is_updated")
 ...
 private boolean  isUpdated;
    ...
    public Project_canal_village_lengths(int lsv_id, int project_id, int comp_type_id, int reservoir_id, int district_id, int mandal_id, int village_id, int total_lascars, int req_lascars, boolean delete_flag, boolean is_latest, Object updated_by, Object deleted_by, Object created_timestamp, Object updated_timestamp, Object deleted_timestamp, int unit_id, int circle_id, int division_id, boolean is_updated) {
        this.lsv_id = lsv_id;
