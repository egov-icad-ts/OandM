...
public class Dee_enter_reqisition_others {
@Column(name="dee_enter_req_other_id")
 
 private Integer  deeEnterReqOtherId;
...
@Column(name="remarks_modify_reject")
 
 private String  remarksModifyReject;
...
@Column(name="survey_number")
 ...
 private String  surveyNumber;
    ...
    public Dee_enter_reqisition_others(int dee_enter_req_other_id, int ee_assign_comp_id, int project_id, int package_id, int district_id, int mandal_id, int village_id, double from_km, double to_km, int survey_id, double requirement_acres, double requirement_guntas, Object north_boundary, Object south_boundary, Object east_boundary, Object west_boundary, Object remarks, Object created_by_userid, int created_by_postid, int created_designation, Object submited_date, boolean delete_flag, int se_assign_package_comp_id, int comp_canal_res_lift_id, int comp_type_id, int no_of_structures, int unit_id, int circle_id, int division_id, int sub_division_id, int status_id, Object remarks_modify_reject, int govt_patta, int crop_type, Object excel_filepath, int dee_req_acq_temp_id, Object deleted_by, Object deleted_time, Object survey_number) {
        this.dee_enter_req_other_id = dee_enter_req_other_id;
        ...
        this.remarks_modify_reject = remarks_modify_reject;
