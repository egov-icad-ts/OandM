...
public class Lao_view_backup {
@Column(name="lao_view_backup_id")
 
 private Integer  laoViewBackupId;
...
@Column(name="govt_patta")
 ...
 private Integer  govtPatta;
    ...
    public Lao_view_backup(int lao_view_backup_id, int lao_view_id, int dee_enter_req_id, int ee_la_file_id, int project_id, int package_id, int district_id, int mandal_id, int village_id, int survey_id, double requirement_acres, double requirement_guntas, Object remarks, int created_by_userid, Object submited_date, boolean delete_flag, boolean is_latest, Object north_boundary, Object south_boundary, Object east_boundary, Object west_boundary, int lao_file_id, int status_id, int govt_patta) {
        this.lao_view_backup_id = lao_view_backup_id;
